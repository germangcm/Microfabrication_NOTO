...
# load mask
im_dir = '/Users/german/EPFL/second_semester/PythonDryEtchModel/ExampleMasks/'
im_file = 'fillet_sq_example_mask.png'
im_path = '/Users/german/EPFL/second_semester/PythonDryEtchModel/ExampleMasks/fillet_sq_example_mask.png'
...
#        cbar.set_clim(0, 2)
    ...
    out_fig = '/Users/german/EPFL/second_semester/PythonDryEtchModel/ExampleMasks/' + \
    str(t) + '.png'
...
#    fig_3d_surf.colorbar(surf, shrink=0.5, aspect=5)
    out_fig = '/Users/german/EPFL/second_semester/PythonDryEtchModel/ExampleMasks/python_model_mask_v0.png' + \
    str(t) + '.png'
    plt.savefig(out_fig, bbox_inches='tight')
    plt.close()
